...
namespace metis_set_detail {
    ...
    auto get_view(metis::core::data_set &ref, idx_t idx) {
        return std::make_unique<view_t>(ref, idx);
    }
...
void nb_metis_sets(nanobind::module_ &m)
{
    ...
    nb::class_<mc::data_set>(m, "set")
      ...
      .def("get_discipline_view",
        [](mc::data_set &ref, mc::discipline_idx_t idx) { return d::get_view<mc::view_discipline>(ref, idx); }
      )
      .def("add_discipline",
        [](mc::data_set &ref) { mc::proc_set p; return d::get_view<mc::view_discipline>(ref, p.add_discipline(ref)); }
      )
      .def("get_family_view",
        [](mc::data_set &ref, mc::query_idx_t idx) { return d::get_view<mc::view_family>(ref, idx); }
      )
      .def("add_family",
        [](mc::data_set &ref) { mc::proc_set p; return d::get_view<mc::view_family>(ref, p.add_family(ref)); }
      )
      .def_prop_ro("subject_count",
        [](const mc::data_set& ref) { return ref.buffers.canonical.subject_names.size(); }
      )
      .def("get_subject_view",
        [](mc::data_set &ref, mc::query_idx_t idx) { return d::get_view<mc::view_subject>(ref, idx); }
      )
      .def("add_subject",
        [](mc::data_set &ref) { mc::proc_set p; return d::get_view<mc::view_subject>(ref, p.add_subject(ref)); }
      )
      .def_prop_ro("query_count",
        [](const mc::data_set& ref) { return ref.buffers.canonical.query_payloads.size(); }
      )
      .def("get_query_view",
        [](mc::data_set &ref, mc::query_idx_t idx) { return d::get_view<mc::view_query>(ref, idx); }
      )
      .def("add_query",
        [](mc::data_set &ref) { mc::proc_set p; return d::get_view<mc::view_query>(ref, p.add_query(ref)); }
      )
    ;
}
